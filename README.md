...
### 1. Rover Firmware (`RoverProject/rover_main/rover_main.ino`)
...
### 2. Camera Firmware (`RoverProject/cam_firmware/cam_firmware.ino`)
...
### 3. Base Bridge Firmware (`RoverProject/base_bridge/base_bridge.ino`)
...
### 4. Base Station Monitor (`RoverProject/base_station/station_monitor.py`)
...
### 5. Dashboard (`RoverProject/rover_dashboard/index.html`)
...
1. Install dependencies:
   ```bash
   cd RoverProject/rover_dashboard
   npm install
   ```
